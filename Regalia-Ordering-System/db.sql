...
INSERT INTO `Regalia_Ordering_System`.`users` (`EMAIL`, `USERNAME`, `FIRST_NAME`, `LAST_NAME`, `ENABLED`, `PHONE_NUMBER`, `WEIGHT`, `HEIGHT_FEET`,`HEIGHT_INCHES`, `GRANTING_INSTITUTION`, `GRANTING_CITY`, `LAST_UPDATED`, `CEREMONY_ID`, `CAP_SIZE_ID`, `DEGREE_ID`, `DEPARTMENT_ID`, `STATE_ID`) VALUES ('steven.bugliione1@marist.edu', '20084250', 'Steven', 'Buglione', '0', '0123456789', '200', '6', '2', 'Marist', 'New York', '2020-10-20 00:00:00', '1', '1', '1', '1', '1');
