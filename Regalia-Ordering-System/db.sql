...
INSERT INTO `Regalia_Ordering_System`.`users` (`EMAIL`, `USERNAME`, `FIRST_NAME`, `LAST_NAME`, `ENABLED`, `PHONE_NUMBER`, `WEIGHT`, `HEIGHT`, `GRANTING_INSTITUTION`, `GRANTING_CITY`, `LAST_UPDATED`, `CEREMONY_ID`, `CAP_SIZE_ID`, `DEGREE_ID`, `DEPARTMENT_ID`, `STATE_ID`) VALUES ('steven.bugliione1@marist.edu', '20084250', 'Steven', 'Buglione', '0', '0123456789', '200', '6-1', 'Marist', 'New York', '2020-10-20 00:00:00', '1', '1', '1', '1', '1');
INSERT INTO `Regalia_Ordering_System`.`users_roles` (`USER_ID`, `ROLE_ID`) VALUES ('11', '1');
