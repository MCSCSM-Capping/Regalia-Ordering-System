...
INSERT INTO `Regalia_Ordering_System`.`USERS` (`USER_ID`, `EMAIL`, `USERNAME`, `FIRST_NAME`, `LAST_NAME`, `PASSWORD`, `ENABLED`, `PHONE_NUMBER`, `WEIGHT`, `HEIGHT_INCHES`, `GRANTING_INSTITUTION`, `GRANTING_CITY`, `LAST_UPDATED`, `CEREMONY_ID`, `CAP_SIZE_ID`, `DEGREE_ID`, `DEPARTMENT_ID`, `STATE_ID`) VALUES ('1', 'Anton.Kochnev1@marist.edu', '20088745', 'Anton', 'Kochnev', 'sunset6395', '0', '9179134628', '200', '72', 'Marist', 'New York', '2020-10-20 00:00:00', '1', '1', '1', '1', '1');
INSERT INTO `Regalia_Ordering_System`.`USERS_ROLES` (`USER_ID`, `ROLE_ID`) VALUES ('1', '3');
INSERT INTO `Regalia_Ordering_System`.`USERS` (`USER_ID`, `EMAIL`, `USERNAME`, `FIRST_NAME`, `LAST_NAME`, `PASSWORD`, `ENABLED`, `PHONE_NUMBER`, `WEIGHT`, `HEIGHT_INCHES`, `GRANTING_INSTITUTION`, `GRANTING_CITY`, `LAST_UPDATED`, `CEREMONY_ID`, `CAP_SIZE_ID`, `DEGREE_ID`, `DEPARTMENT_ID`, `STATE_ID`) VALUES ('2', 'bob@marist.edu', '12345678', 'bob', 'saget', 'password', '0', '0123456789', '200', '72', 'Marist', 'New York', '2020-10-20 00:00:00', '1', '1', '1', '1', '1');
INSERT INTO `Regalia_Ordering_System`.`USERS_ROLES` (`USER_ID`, `ROLE_ID`) VALUES ('1', '1');
